            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-stretch mb-20">
                    ...
                    >
                        ...
                        <p className="text-[#1E293B] font-bold mb-8 px-4 min-h-[64px] flex items-center justify-center leading-tight">
                            לעסקים שרוצים להתחיל לעבוד מסודר
                        </p>
                        ...
                        <ul className="space-y-4 mb-8 flex-grow w-full text-right px-4">
                            <li className="flex items-start gap-3 text-sm text-gray-600">
                                <span className="mt-1 text-green-500 font-bold"><CheckIcon /></span>
                                <span>משתמשים ורשומות ללא הגבלה</span>
                            </li>
                            <li className="flex items-start gap-3 text-sm text-gray-600">
                                <span className="mt-1 text-green-500 font-bold"><CheckIcon /></span>
                                <span>CRM עם יומן, טפסים, דפי נחיתה ופייפליין</span>
                            </li>
                            <li className="flex items-start gap-3 text-sm text-gray-600">
                                <span className="mt-1 text-green-500 font-bold"><CheckIcon /></span>
                                <span>ניהול לידים ודשבורד איכותי</span>
                            </li>
                        </ul>
                    ...
                    >
                        ...
                        <p className="text-[#1E293B] font-bold mb-8 px-4 min-h-[64px] flex items-center justify-center leading-tight">
                            לעסקים בצמיחה שרוצים לשדרג ולשווק בצורה מסודרת
                        </p>
                        ...
                        <ul className="space-y-4 mb-8 flex-grow w-full text-right px-4">
                            <li className="flex items-start gap-3 text-sm text-gray-600">
                                <span className="mt-1 text-[#F59E0B] font-bold"><CheckIcon /></span>
                                <span>כל מה שיש ב-PRO ובנוסף:</span>
                            </li>
                            <li className="flex items-start gap-3 text-sm text-gray-600">
                                <span className="mt-1 text-[#F59E0B] font-bold"><CheckIcon /></span>
                                <span>אינטגרציית וואטסאפ (לא רשמי) וטריגרים</span>
                            </li>
                            <li className="flex items-start gap-3 text-sm text-gray-600">
                                <span className="mt-1 text-[#F59E0B] font-bold"><CheckIcon /></span>
                                <span>Funnels שיווקיים וניהול רשימות תפוצה</span>
                            </li>
                            <li className="flex items-start gap-3 text-sm text-gray-600">
                                <span className="mt-1 text-[#F59E0B] font-bold"><CheckIcon /></span>
                                <span>מנהל מודעות פייסבוק וגוגל מובנה</span>
                            </li>
                        </ul>
                    ...
                    >
                        ...
                        <p className="text-[#1E293B] font-bold mb-8 px-4 min-h-[64px] flex items-center justify-center leading-tight">
                            לעסקים שמבינים את הכח והשליטה שמתקבלים ממערכת CRM עוצמתית משולבת AI
                        </p>
                        ...
                        <ul className="space-y-4 mb-8 flex-grow w-full text-right px-4">
                            <li className="flex items-start gap-3 text-sm text-gray-600">
                                <span className="mt-1 text-[#DC2626] font-bold"><CheckIcon /></span>
                                <span>כל מה שיש ב-SMART ובנוסף:</span>
                            </li>
                            <li className="flex items-start gap-3 text-sm text-gray-600">
                                <span className="mt-1 text-[#DC2626] font-bold"><CheckIcon /></span>
                                <span>בניית אתרים ודפי נחיתה ב-AI</span>
                            </li>
                            <li className="flex items-start gap-3 text-sm text-gray-600">
                                <span className="mt-1 text-[#DC2626] font-bold"><CheckIcon /></span>
                                <span>בוטים AI חכמים שעונים ללקוחות בוואטסאפ</span>
                            </li>
                            <li className="flex items-start gap-3 text-sm text-gray-600">
                                <span className="mt-1 text-[#DC2626] font-bold"><CheckIcon /></span>
                                <span>API, וובהוקים ואוטומציות מתקדמות</span>
                            </li>
                        </ul>
