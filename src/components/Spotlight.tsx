...
export const Spotlight = () => {
    ...
    useEffect(() => {
        // Purely decorative cursor-tracking glow -- respect
        // prefers-reduced-motion instead of forcing continuous motion.
    ...
    return (
        <div data-testid="ambient-spotlight" aria-hidden="true" className="fixed inset-0 pointer-events-none overflow-hidden z-50">
            <motion.div
