...
export const HOMEPAGE_FAQS: FAQItem[] = [
    ...
    },
    {
        ...
        answer: "כן. אלטרוביז מתממשקת באופן מובנה לטפסי לידים של פייסבוק, אינסטגרם, גוגל, ודפי נחיתה. כל ליד שנרשם נכנס ישירות למערכת וניתן להפעיל טריגר מיידי ששולח אליו וואטסאפ או מייל ומעדכן את נציג המכירות."
    },
    {
        question: "איך בוט ה-AI של אלטרוביז קובע פגישות ביומן באופן עצמאי?",
        answer: "בוט ה-AI מקושר ליומן הפגישות שלך ומתוכנת להבין את השירותים והזמינות של העסק. כאשר ליד מתעניין בפגישה, הבוט בודק חלונות פנויים, מציע שעות לבחירה בשיחת וואטסאפ טבעית, ומשריין את הפגישה ביומן תוך שליחת תזכורות אוטומטיות."
    }
];

export const ARTICLE_WHATSAPP_FAQS: FAQItem[] = [
    {
        question: "האם מותר לשלוח הודעת WhatsApp למי שהשאיר פרטים בטופס באתר?",
